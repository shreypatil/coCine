...
function App() {
  ...
  reactExports.useEffect(() => {
    const onKey = (e) => {
      ...
      if (e.key === " ") {
        ...
        void window.cocine.setFullScreen();
      } else if (e.key === "Escape" && s?.fullscreen) {
        void window.cocine.setFullScreen(false);
      } else if (e.key === "ArrowRight" && s?.mediaName) {
        void guard(() => window.cocine.seek(pos + 10));
      } else if (e.key === "ArrowLeft" && s?.mediaName) {
        void guard(() => window.cocine.seek(Math.max(0, pos - 10)));
      }
    };
  ...
  const onDrop = (e) => {
    ...
    if (!path) {
      setError("Could not read a path from that file");
      return;
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      onDrop,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "topbar", "data-testid": "header", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "brand", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              onClick: () => {
                console.log("open film clicked");
                void guard(() => window.cocine.openFile());
              },
              children: "Open film"
            }
          ),
        ...
        error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "banner", role: "alert", "data-testid": "banner", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setError(null), "aria-label": "Dismiss", children: "Dismiss" })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "controls", "data-testid": "controls", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              className: "play",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tc", "data-testid": "position", children: clock(s?.positionSec) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "track", style: { ["--p"]: `${progress}%` }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              className: "scrub",
              type: "range",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tc", "data-testid": "duration", children: clock(duration) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              className: "icon",
              "data-testid": "fullscreen",
              onClick: () => void window.cocine.setFullScreen(),
              "aria-label": "Toggle fullscreen",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { viewBox: "0 0 16 16", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M1 1h5v2H3v3H1zm14 0v5h-2V3h-3V1zM1 10h2v3h3v2H1zm14 0v5h-5v-2h3v-3z" }) })
            }
          )
        ] })
      ]
